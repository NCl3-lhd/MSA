...
std::vector<std::array<std::string, 2>> getAlignedSeqs(int, const std::vector<std::string>&, int);
...
void starAlign(const std::vector<std::string>&, std::vector<std::string>&, int);
#endif